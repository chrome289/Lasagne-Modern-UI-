...
namespace Lasagne__Modern_UI_
{
    public partial class Create : UserControl
    {
        ...
        public Create()
        {
            ...
            //create table
            string sql = "CREATE TABLE if not exists 'sync' ('no'	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,'name'	varchar(100) NOT NULL UNIQUE,'First_Folder'	varchar(500) NOT NULL,'Second_Folder'	varchar(500) NOT NULL,'is_two_way'	integer(10) NOT NULL);";
